...
| 抽象 GUI（App / Widget / 平台接口） | `gis-desktop-win32/src/ui/app.*`、`widget.*`、`widgets.*`、`widgets_shell.*`、`widgets_all.h`、`ui_types.h`、`platform_gui.h`（类图见 [uml-class-ui.md](uml-class-ui.md)） |
