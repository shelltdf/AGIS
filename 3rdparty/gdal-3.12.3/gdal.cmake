...
# When embedded, do not attach EXPORT (PROJ::proj is not in an export set).
if(CMAKE_VERSION VERSION_LESS 3.21 OR PROJECT_IS_TOP_LEVEL)
  install(
...
# Skip when GDAL is add_subdirectory'd under another project (e.g. AGIS): linked PROJ is not exported.
if(CMAKE_VERSION VERSION_LESS 3.21 OR PROJECT_IS_TOP_LEVEL)
...
# PROJ (and other subprojects) may already define target "uninstall" in the same top-level build.
